...
public class ListMahasiswaActivity extends AppCompatActivity {
    String[] items ={"Brayen","Baskoro","Arnold","Verina","Yubelince"};
    ...
    public void GoToCreate(View view) {
        Intent intent = new Intent(ListMahasiswaActivity.this, com.example.crudmahasiswa.CreateMhsActivity.class);
        startActivity(intent);
    }

    public void GoToUpdate(View view) {
        Intent intent = new Intent(ListMahasiswaActivity.this, com.example.crudmahasiswa.UpdateMhsActivity.class);
        startActivity(intent);
    }
}